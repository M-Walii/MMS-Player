"""Generate MMS Prime using quaternion inflections for DURCHFAHREN2 with torso compensation (H50-R50-T50)."""
...
def apply_inflections(
    ...
    """Apply quaternion inflections for DURCHFAHREN2 with torso compensation (H50-R50-T50)."""
    ...
    for line_num, row in mms_df.iterrows():
        ...
        if maingloss == 'DURCHFAHREN2':
            ...
            print(f"\n{'='*60}")
            print(f"Line {line_num}: DURCHFAHREN2 inflection calculated (H50-R50-T50, torso-comp)")
            print(f"{'='*60}")
...
def main() -> None:
    try:
        ...
        print(f"\n{'='*60}")
        print(f"DURCHFAHREN2 QUATERNION METHOD - MMS Prime Generation (H50-R50-T50, torso-comp)")
        print(f"{'='*60}")
